...
// import Power from "../entity/Power";class Controller {    constructor() {}
...
//                 let requestPower = requestSuperHero.power;                let superHero = new SuperHero();
//                 superHero.name = requestSuperHero.name;
//                 superHero.power = [];                requestPower.forEach(requestPower => {
...
//         connection
//             .then(async connection => {                let superHero  = await connection.manager.findOne(SuperHero, req.params.superHeroId);                let requestSuperHero = req.body;
//                 let requestPower = requestSuperHero.power;                superHero.name = requestSuperHero.name;
...
//                 await connection.manager.remove(SuperHero, {id: req.params.superHeroId});                res.json({message: "Successfully Removed."})
//             })
//             .catch(error => {
//                 console.error("Error ", error);
//                 res.json(error);
